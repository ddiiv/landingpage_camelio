                ...
                <section id="footer">
                    ...
                    <div className="row">
                        <div className="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center text-white">
                            <p className="h6"><a className='rights'>© All right Reversed.</a><a className="text-green ml-2" href="https://www.sunlimetech.com" target="_blank">Camellia Naturals -ARREGLAR ASDASDAS</a></p>
                        </div>
                    </div>
            </section>
        </>
